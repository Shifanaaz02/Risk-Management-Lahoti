...
function myFunction(){
  ...
  if(y.options[y.selectedIndex].text == "Select Amount"){
    text= 0;
    return 0;
  }
  else{
...
function myFunction3(){
  ...
  var d = document.getElementById("risk-class3").value;
...
function myFunction5(){
  var y = document.getElementById('risk-class5');
...
function myFunction7(){
  var s = document.getElementById("risk-class7").value;
  var text;
...
function myFunction10(){
  var y = document.getElementById("risk-class10");
  var value =0;
  var text = document.getElementById("loan");
  first_income = parseInt(document.getElementById("first_income").value)
   second_income = parseInt(document.getElementById("second_income").value)
   third_income = parseInt(document.getElementById("third_income").value)
  result = ((first_income + second_income + third_income)/3/12) - (((first_income + second_income + third_income)/3/12)%1000);
  ...
  document.getElementById("select8").innerHTML = text.value;
...
function myFunction11(){
  var y = document.getElementById("risk-class11").value;
...
function myFunction12(){
  ...
  var text;
  value = parseInt(y.options[y.selectedIndex].value);
  if(y.options[y.selectedIndex].text == "Sum Insured"){
...
function myFunction14()
{
  ...
  var avg = (((first_income + second_income + third_income)/3)/30)/12
  // console.log(avg)
  var ans = 0;
...
function myFunction15()
{
  ...
  var second_income = parseInt(document.getElementById("second_income").value)
  var third_income = parseInt(document.getElementById("third_income").value)
  var risk_class = document.getElementById("risk-class11").value
 ...
 else if(document.getElementById("risk-class11").options[document.getElementById("risk-class11").selectedIndex].text == "Risk Class"){
  document.getElementById("value9").innerHTML = 0;
 document.getElementById("select9").innerHTML = 0;
  return 0;
}
