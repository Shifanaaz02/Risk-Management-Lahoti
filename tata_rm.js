...
function display() {
  ...
  var base_death = parseInt(document.getElementById("death_sum_assured").value);
  ...
  var avg_mon =
    (first_income + second_income + third_income) / 3 / 12 -
    (((first_income + second_income + third_income) / 3 / 12) % 1000);
  ...
  if (y.options[y.selectedIndex].value == 1) {
    document.getElementById("base-cover").innerHTML = "TATA AIG RM";
  }
  if (y.options[y.selectedIndex].value == 2) {
    document.getElementById("base-cover").innerHTML =
      "BASE COVER (Category II)";
  }
  if (y.options[y.selectedIndex].value == 3) {
    document.getElementById("base-cover").innerHTML =
      "BASE COVER (Category III)";
  }
  if (document.getElementById("first_income").value == "") {
    ...
    if (
      ...
      if (y.options[y.selectedIndex].value == 1) {
        document.getElementById("pre-1").innerHTML = Math.round(
          (result * 100 * 0.43) / 1000
        );
        document.getElementById("pre-2").innerHTML = Math.round(
          (result * 60 * 0.05) / 1000
        );
        document.getElementById("pre-3").innerHTML = Math.round(
          (result * 60 * 0.07) / 1000
        );
        return (
          Math.round((result * 100 * 0.43) / 1000) +
          Math.round((result * 60 * 0.05) / 1000) +
          Math.round((result * 60 * 0.07) / 1000)
        );
      } else if (y.options[y.selectedIndex].value == 2) {
        document.getElementById("pre-1").innerHTML = Math.round(
          (result * 100 * 0.69) / 1000
        );
        document.getElementById("pre-2").innerHTML = Math.round(
          (result * 60 * 0.17) / 1000
        );
        ...
        return (
          Math.round((result * 100 * 0.69) / 1000) +
          Math.round((result * 60 * 0.17) / 1000) +
          Math.round((result * 60 * 0.19) / 1000)
        );
      }
    } else if (
      base_death < avg_mon * 100 &&
      ...
      first_income = 0; //parseInt(document.getElementById("first_income").value);
      second_income = 0; //parseInt(document.getElementById("second_income").value);
      third_income = 0; //parseInt(document.getElementById("third_income").value);
      result =
        (first_income + second_income + third_income) / 3 / 12 -
        (((first_income + second_income + third_income) / 3 / 12) % 1000);
      document.getElementById("inc-1").innerHTML = result;
      ...
      if (y.options[y.selectedIndex].value == 1) {
        ...
        return (
          Math.round((base_death * 0.43) / 1000) +
          Math.round((base_PTD * 0.05) / 1000) +
          Math.round((base_PPD * 0.07) / 1000)
        );
      } else if (y.options[y.selectedIndex].value == 2) {
        document.getElementById("pre-1").innerHTML = Math.round(
          (base_death * 0.69) / 1000
        );
        document.getElementById("pre-2").innerHTML = Math.round(
          (result * 60 * 0.17) / 1000
        );
        ...
        return (
          Math.round((base_death * 0.69) / 1000) +
          Math.round((base_PTD * 0.17) / 1000) +
          Math.round((base_PPD * 0.19) / 1000)
        );
      }
    } else if (
      base_death == avg_mon * 100 &&
...
function myFunction7() {
  ...
  if (premium == 0) {
    ...
    text = parseInt(
      document.getElementById("sum7").options[
        document.getElementById("sum7").selectedIndex
      ].text
    );
...
function myFunction15() {
  ...
  if (document.getElementById("first_income").value == "") {
    ...
    document.getElementById("risk-class").options[
      document.getElementById("risk-class").selectedIndex
    ].text == "Risk Class"
  ) {
    document.getElementById("value9").innerHTML = 0;
    document.getElementById("select9").innerHTML = 0;
...
function premiumprint() {
  ...
  document.getElementById("printpremium").innerHTML =
    "Premium Value : " + parseInt(premiumothercompany);
}
...
function myFunction20() {
  ...
  var avg =
    ...
    (((first_income + second_income + third_income) / 3 / 12) % 1000);
  document.getElementById("avg_value").innerHTML = avg;
  document.getElementById("pdf_monthlyAvgIncome").innerHTML = avg;
  console.log("hello");
